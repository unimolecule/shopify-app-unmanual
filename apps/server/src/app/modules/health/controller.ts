...
export function registerHealthController(app: AppOpenAPI) {
  return app
    ...
    .openapi(getDiskHealthRoute, async (c) =>
      c.json(
        createResponse({
    ...
    .openapi(getMemoryHealthRoute, async (c) =>
      c.json(
        createResponse({
    ...
    .openapi(getNetworkHealthRoute, async (c) =>
      c.json(
        createResponse({
    ...
    .openapi(getDatabaseHealthRoute, async (c) =>
      c.json(
        createResponse({
