...
export function registerProductExportController(app: AppOpenAPI) {
  return app
    .openapi(createProductExportRoute, async (c) => {
      try {
    ...
    .openapi(listProductExportsRoute, async (c) => {
    ...
    .openapi(listProductExportTemplatesRoute, (c) =>
      c.json(
        createResponse({
    ...
    .openapi(getProductExportRoute, async (c) =>
      c.json(
        createResponse({
    ...
    .openapi(downloadProductExportRoute, async (c) => {
    ...
    .openapi(deleteProductExportRoute, async (c) => {
